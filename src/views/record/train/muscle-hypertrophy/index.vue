 ...
 * @LastEditTime: 2022-12-23 15:29:52
 * @Description : 肌肥大训练-数据记录
-->
<template>
  <div class="muscle-hypertrophy-record">
    <!-- 顶部 -->
    <div class="top">
      <!-- 标题 -->
      <el-page-header
    ...
    handleCheckPdf(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/train-record/muscle-hypertrophy-record')
        }
      })
    },
