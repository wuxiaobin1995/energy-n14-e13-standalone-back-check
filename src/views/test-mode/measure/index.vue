 ...
 * @LastEditTime: 2022-09-26 11:27:24
 * @Description : 测试具体测量
-->
<template>
    ...
    <div class="btn-wrapper">
      <div class="btn-left">
        <el-button
          ...
          :disabled="this.testValueArray.length === 3 || isStart ? true : false"
          @click="handleStart"
          >开始测量</el-button
        >
        <el-button
        ...
        <el-button
          ...
          >重新测量</el-button
        >
        <el-button class="size refresh" round type="info" @click="handleRefresh"
          >刷新</el-button
        >
      </div>
      <div class="btn-right">
...
export default {
  ...
  methods: {
            ...
            this.parser.on('data', data => {
              ...
              if (!isNaN(this.oneWeight) && !isNaN(this.twoWeight)) {
                ...
                if (this.oneWeight > 200 || this.twoWeight > 200) {
                  ...
                  // 实时渲染图形
                  if (this.useP1.includes(this.$route.query.testName)) {
                    this.option.series[0].data = this.oneWeightArray
                  } else if (this.useP2.includes(this.$route.query.testName)) {
    ...
    initChart() {
      ...
      this.option = {
        title: {
          text: this.$route.query.chineseName,
          left: 'center',
          textStyle: {
            fontSize: 28
          }
    ...
    handleRefresh() {
      ...
      //     testName: this.$route.query.testName,
    ...
    handleFinish() {
      ...
      if (isNaN(this.testResult)) {
        ...
        valueObj[`${this.$route.query.testName}`] = this.testResult
